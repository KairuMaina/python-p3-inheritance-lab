#!/usr/bin/env python3
from lib.teacher import Teacher  # Correct import
...
class TestTeacher:
    ...
    def test_is_subclass(self):
        ...
        assert issubclass(Teacher, User)  # Use issubclass instead of checking __bases__
    ...
    def test_can_teach(self):
        ...
        my_teacher = Teacher("My", "Teacher")  # Re-instantiate to reset state
